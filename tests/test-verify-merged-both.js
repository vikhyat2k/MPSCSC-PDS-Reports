...
(async () => {
    ...
    console.log('Total PDF Pages with both columns merged:', parsed.total);
    ...
    await page.screenshot({ path: 'tests/merged_both_verified.png' });
    console.log('Saved screenshot to tests/merged_both_verified.png');
    await browser.close();
})();
