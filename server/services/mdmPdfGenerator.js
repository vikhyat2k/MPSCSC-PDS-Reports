...
class MDMPDFGenerator {
    ...
    async generateReport(processedData, month, year) {
        ...
        // Aggregate totals per grain from all shops
        ...
        sectorGrains.forEach((s, i) => {
            ...
            // MDM: 17 data cols — has MDM दुकान (FPS shop count) column
            rows += `
                <tr>
        ...
        <head>
            ...
            <style>
                ...
                * { box-sizing: border-box; }
                ...
                col.c4  { width: 3.5%; }  /* MDM दुकान */
                col.c5  { width: 13%; }   /* सेक्टर */
                col.c6  { width: 5.5%; }  /* wheat allot */
                col.c7  { width: 5.5%; }  /* wheat disp */
                col.c8  { width: 4.5%; }  /* wheat disp% */
                col.c9  { width: 5.5%; }  /* wheat rec Qt */
                col.c10 { width: 4.5%; }  /* wheat rec% */
                col.c11 { width: 5.5%; }  /* rice allot */
                col.c12 { width: 5.5%; }  /* rice disp */
                col.c13 { width: 4.5%; }  /* rice disp% */
                col.c14 { width: 5.5%; }  /* rice rec Qt */
                col.c15 { width: 4.5%; }  /* rice rec% */
                col.c16 { width: 12.8%; } /* transporter */
                col.c17 { width: 7%; }    /* mobile */
            </style>
        </head>
        <body>
            <h2>म०प्र० स्टेट सिविल सप्लाईज़ कार्पो लि० जिला कार्यालय बैतूल</h2>
            <h3>MDM (मध्यान्ह भोजन) खाद्यान्न माह ${monthName} ${year} आवंटन / उठाव / रिसिविंग</h3>
        ...
        const filename = `MDM_Report_${monthNameStr}_${year}_${uuidv4().substring(0,8)}.pdf`;
...
module.exports = MDMPDFGenerator;
